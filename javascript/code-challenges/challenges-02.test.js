...
const raisedToTheThird = (arr) => {
  ...
  let arrayOutput = [];
  arr.forEach((num) => {
    arrayOutput.push(Math.pow(num, 3));
  });
  return arrayOutput;
};
...
The "raisedToTheThird" function  takes an array of numbers, then applies the Math.pow function
 to each element to raise it to the power of 3.
 Then returns a new array containing the results.
Then utilizing  the forEach method to iterate through the input array and perform the desired calculation on each element.
